...
**Version:** PAI 5.0.0 | Algorithm v6.4.10 | Memory v7.6
...
- **Version:** v6.4.10 (canonical: read `PAI/ALGORITHM/LATEST`)
...
| **Algorithm** | `Algorithm/LATEST` → `Algorithm/v{VERSION}.md` (currently v6.4.10), `Algorithm/capabilities.md`, `Algorithm/mode-detection.md`, `hooks/ISASync.hook.ts` → `MEMORY/WORK/{slug}/ISA.md`, `skills/ISA/` (canonical Scaffold/Append/Reconcile workflows) |
