...
- **Verification Doctrine** — Rules 1/2/2a/3 are mandatory where they apply. Rule 2a (cross-vendor audit) is E4/E5 always, PLUS E3 when the work is correctness-critical (security surface, destructive/irreversible op, auth/crypto/data-integrity) — NEW v6.4.2.
