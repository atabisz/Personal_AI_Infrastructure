...
**Example:** Vendor press release → trade blog → mainstream outlet → social post. By post-stage the "99% expect any AI-related workforce change" has become "all CEOs planning mass layoffs."
...
- Op-ed dressed as analysis → wrong tool; redirect to `ContentAnalysis`
