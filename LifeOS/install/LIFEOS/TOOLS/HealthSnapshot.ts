...
const INBOX = join(homedir(), "Library/Mobile Documents/com~apple~CloudDocs/LIFEOS/health/inbox")
const PROCESSED = join(homedir(), "Library/Mobile Documents/com~apple~CloudDocs/LIFEOS/health/processed")
